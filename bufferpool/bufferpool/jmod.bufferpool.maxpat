...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter mainfolder @type array @repetitions/filter 1 @description \"path of the parent folder dropped in, containing subfolders with sound files in \"",
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 251.0, 171.0, 866.0, 577.0 ],
										"bglocked" : 0,
										"defrect" : [ 251.0, 171.0, 866.0, 577.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 145.0, 466.713257, 340.0, 32.0 ],
													"text" : ";\n#0_xxx_buftp script send $1 replace $5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 145.0, 429.713257, 54.0, 20.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 51.0, 452.713257, 54.0, 20.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 51.0, 428.713257, 54.0, 20.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 51.0, 381.713257, 54.0, 20.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 51.0, 474.713257, 54.0, 20.0 ],
													"text" : "del 50"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 50.0, 504.713257, 111.0, 20.0 ],
													"text" : "s #0_xxx_nxtsnd"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "", "" ],
													"patching_rect" : [ 51.0, 405.713257, 206.0, 20.0 ],
													"text" : "t b l l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 238.0, 428.713257, 340.0, 32.0 ],
													"text" : ";\n#0_xxx_buftp script new $1 newex $3 $2 $4 9 buffer~ $1 "
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 163.145554, 135.999786, 173.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 823.972717, 20.081207, 139.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 54.0, 272.0, 1087.0, 540.0 ],
										"bglocked" : 0,
										"defrect" : [ 54.0, 272.0, 1087.0, 540.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "j.message type @type array @repetitions/filter 0 @description \"Open sound file specified by filename. Without a filename a standard open file dialog allows you to choose a file.\"",
...
, 			{
				"box" : 				{
					...
					"text" : "j.hub @description \"A module for autogenerating buffers from folders and files\"",
					"varname" : "j.hub"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.message path @type array @repetitions/filter 0 @description \"path of the parent folder dropped in, containing subfolders with sound files in or path of the sound file dropped in\"",
