{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 107.0, 44.0, 1250.0, 685.0 ],
		"bglocked" : 0,
		"defrect" : [ 107.0, 44.0, 1250.0, 685.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 275.0, 380.0, 61.0, 20.0 ],
					"text" : "sfrecord~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 153.0, 300.0, 51.466908, 17.933016 ],
					"presentation" : 1,
					"presentation_rect" : [ 240.0, 3.0, 43.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 159.0, 316.0, 520.0, 460.0 ],
						"bglocked" : 0,
						"defrect" : [ 159.0, 316.0, 520.0, 460.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 148.0, 339.0, 51.0, 18.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 103.0, 362.0, 72.0, 18.0 ],
									"text" : "prepend open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 175.0, 90.0, 18.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 314.0, 196.0, 18.0 ],
...
,
					"patching_rect" : [ 275.0, 312.0, 51.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter timeambitus/min @type integer @range 0. 2000. @description \"Ambitus speed for mooving algo\" @repetitions/filter 0 @priority 20",
...
,
					"patching_rect" : [ 457.0, 356.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 457.0, 309.0, 61.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 659.0, 121.0, 80.0, 80.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter volume @type decimal @range 0. 1. @clipmode both @ramp/drive scheduler @description \"Ouput Volume.\" @ramp/drive scheduler",
...
,
					"patching_rect" : [ 457.0, 454.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 457.0, 396.0, 68.0, 15.0 ],
					"peakcolor" : [ 0.019608, 0.0, 0.690196, 1.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter aux.1 @type decimal @ramp/drive scheduler @range 0. 1. @clipmode both @description \"Send level to aux 1.\" @ramp/drive scheduler",
...
,
					"patching_rect" : [ 457.0, 548.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 457.0, 490.0, 67.0, 13.0 ],
					"peakcolor" : [ 0.019608, 0.0, 0.690196, 1.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 229.0, 34.0, 21.996094, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "lsp3l"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter aux.2 @type decimal @range 0. 1. @ramp/drive scheduler @clipmode both @description \"Send level to aux 2.\" @ramp/drive scheduler",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 268.0, 16.0, 54.0, 17.0 ],
					"text" : "aux.1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 814.0, 70.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 84.0, 36.0, 17.0 ],
					"text" : "speed",
					"varname" : "speedcom"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 176.0, 20.0, 61.0, 17.0 ],
					"text" : "output setup "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 800.0, 70.0, 55.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 84.0, 91.0, 17.0 ],
					"size" : 2000.0,
					"varname" : "speedslid"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 480.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.0, 425.0, 256.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 268.0, 79.0, 17.0 ],
					"text" : "prepend symbol"
				}
...
,
					"patching_rect" : [ 608.0, 268.0, 50.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 802.0, 110.0, 80.0, 17.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.0, 222.0, 56.0, 17.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 608.0, 286.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter timeambitus/max @type integer @range 0. 2000. @description \"Ambitus speed for mooving algo\" @repetitions/filter 0 @priority 21",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.0, 202.0, 56.0, 17.0 ],
					"text" : "pak 0 0"
				}
...
,
					"patching_rect" : [ 660.0, 208.0, 80.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 38.0, 66.0, 17.0 ],
									"text" : "r #1lsptd"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 58.0, 65.0, 17.0 ],
									"text" : "r #1lsptc"
								}
...
,
					"patching_rect" : [ 800.0, 48.0, 35.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 200.0, 67.0, 18.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 20.0, 21.996094, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "lsp2l"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 229.0, 20.0, 21.996094, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "lsp1l"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 35.0, 21.996094, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "lsp4l"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 97.5, 377.5, 129.5, 377.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 97.5, 377.0, 284.5, 377.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 466.5, 380.0, 437.0, 380.0, 437.0, 300.0, 466.5, 300.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 668.5, 207.0, 669.5, 207.0 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 466.5, 479.0, 443.0, 479.0, 443.0, 384.0, 466.5, 384.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 466.5, 574.0, 442.0, 574.0, 442.0, 483.0, 466.5, 483.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 617.5, 287.0, 617.5, 287.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 1003.5, 240.0, 855.0, 240.0, 855.0, 207.0, 786.0, 207.0, 786.0, 66.0, 809.5, 66.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 669.5, 229.0, 645.0, 229.0, 645.0, 114.0, 668.5, 114.0 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 162.5, 326.0, 138.0, 326.0, 138.0, 261.0, 162.5, 261.0 ],
					"source" : [ "obj-49", 0 ]
				}
