...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter revtime @type decimal @repetitions/filter 0 @range/bounds 0.1 360. @description \"• Reverb time (s): Reverb decay time, in seconds. 7 is a good place to start. Values: 0.1 - 360 seconds!\"",
					"varname" : "bands[3]"
				}
