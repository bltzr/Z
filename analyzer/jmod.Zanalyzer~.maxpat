...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch[7]",
									"text" : "j.parameter npartial @type integer @repetitions/filter 1 @description \"• Higher partials are weighed less strongly than lower ones in determining the pitch -- this specifies the number of the partial (7) which will be weighted half as strongly as the fundamental.\"",
									"linecount" : 3,
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch[5]",
									"text" : "j.parameter vibrato/interval @type decimal @repetitions/filter 1 @description \"backlash for pitch  tracking\"",
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch[6]",
									"text" : "j.parameter vibrato/period @type integer @repetitions/filter 1 @description \" A period in milliseconds  over which the raw pitch may not deviate more than an interval in half-tones specified by the vibrato/interval parameter from the average pitch to report it as a note to the cooked pitch outlet.\"",
									"linecount" : 3,
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch[4]",
									"text" : "j.parameter reattack/dynamic @type integer @repetitions/filter 1 @description \" if the amplitude rises more than this parameter during reattack/period, the re-attack will result in a bang in the attack outlet and may give rise to repeated notes in the cooked pitch output.\"",
									"linecount" : 3,
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch[3]",
									"text" : "j.parameter reattack/period @type integer @repetitions/filter 1 @description \"• A period in milliseconds  over which a re-attack is reported if the amplitude rises more than reattack/dynamic  parameter.\"",
									"linecount" : 2,
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"varname" : "pitch",
									"text" : "j.parameter hopsize @type integer @repetitions/filter 1 @description \"Hop size in # of sample for the analysis\"",
									"linecount" : 2,
									"numoutlets" : 3,
									"fontsize" : 9.0,
									"outlettype" : [ "", "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "pitch[13]",
					"text" : "j.return attack @repetitions/filter 0 @description \"bang on attack detection\"",
					"numoutlets" : 2,
					"fontsize" : 9.0,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "pitch[2]",
					"text" : "j.parameter threshold/high @type integer @repetitions/filter 0 @description \"Hight threshold\"",
					"linecount" : 3,
					"numoutlets" : 3,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "pitch[1]",
					"text" : "j.parameter threshold/low @type integer @repetitions/filter 0 @description \"low threshold \"",
					"linecount" : 2,
					"numoutlets" : 3,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
