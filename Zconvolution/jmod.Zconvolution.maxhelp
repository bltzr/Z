...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.0, 696.0, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 679.0, 81.0, 20.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 679.0, 195.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 678.0, 182.0, 17.0 ],
					"text" : "/view/size 300 140"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 533.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 533.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 347.0, 142.0, 18.0 ],
					"text" : "s jmod.Zconvolution~.help"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 95.0, 429.0, 104.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.Zconvolution~.maxpat",
					"numinlets" : 5,
					"numoutlets" : 5,
					"outlettype" : [ "", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 21.0, 415.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "4 channels convolution based on Zconvolution.mxo",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 393.0, 141.0, 18.0 ],
					"text" : "r jmod.Zconvolution~.help"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 337.5, 507.0, 337.5, 507.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 337.5, 528.0, 30.5, 528.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 311.5, 507.0, 618.5, 507.0 ],
					"source" : [ "obj-8", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 241.25, 507.0, 478.0, 507.0 ],
					"source" : [ "obj-8", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 171.0, 507.0, 311.5, 507.0 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 100.75, 507.0, 171.0, 507.0 ],
					"source" : [ "obj-8", 1 ]
				}
