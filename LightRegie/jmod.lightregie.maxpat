{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1211.260986, 457.09906, 300.0, 105.0 ],
		"bglocked" : 0,
		"defrect" : [ 105.0, 173.0, 1250.0, 748.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.0, 414.0, 35.0, 18.0 ],
					"text" : "K go"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.5, 412.0, 101.0, 20.0 ],
					"text" : "prepend port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 625.5, 412.0, 101.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 772.0, 167.0, 173.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 1054.0, 90.0, 307.0, 85.0 ],
						"bglocked" : 0,
						"defrect" : [ 1054.0, 90.0, 307.0, 85.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 554.5, 411.0, 48.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 412.0, 86.0, 20.0 ],
					"text" : "sprintf c1 %ld"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 381.0, 387.0, 541.0, 20.0 ],
					"text" : "jcom.oscroute /inhibition /chaser/level /view/panel /IP /port /go"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 773.0, 63.0, 208.0, 34.0 ],
					"text" : "jcom.parameter.array 120 channel @type integer @range/bounds 0 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 643.0, 34.0, 50.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 474.0, 57.0, 188.0, 48.0 ],
					"text" : "jcom.parameter.array 8 master @type integer @range/bounds 0 255"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 483.5, 106.0, 467.5, 106.0, 467.5, 25.0, 483.5, 25.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 842.5, 445.0, 101.5, 445.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 477.5, 446.0, 101.5, 446.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 635.0, 444.75, 101.5, 444.75 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 738.0, 445.25, 101.5, 445.25 ],
					"source" : [ "obj-60", 0 ]
				}
