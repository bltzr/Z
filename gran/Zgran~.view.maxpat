...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 200.0, 308.0, 100.0, 17.0 ],
					"text" : "jcom.remote density/jit",
					"varname" : "dispstart[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 308.0, 68.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 232.0, 40.0, 68.0, 19.0 ],
					"text" : " jit"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 68.0, 305.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 201.5, 40.0, 36.5, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 833.25, 179.0, 102.0, 17.0 ],
					"text" : "jcom.receive bufferpool",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 852.25, 211.0, 86.0, 17.0 ],
					"text" : "jcom.receive buffer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 814.25, 148.0, 85.0, 17.0 ],
					"text" : "jcom.receive folder",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 457.0, 316.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 424.0, 463.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 814.25, 248.0, 57.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 393.0, 447.0, 149.0, 19.0 ],
					"text" : "jcom.remote display/length"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 393.0, 410.0, 141.0, 19.0 ],
					"text" : "jcom.remote display/start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 325.0, 308.0, 127.0, 19.0 ],
					"text" : "jcom.remote buffersize"
				}
...
,
					"patching_rect" : [ 456.0, 337.0, 44.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 83.0, 542.0, 50.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"buffername" : "G-train_flak+wouu04.aif",
					"clipdraw" : 1,
					"grid" : 500.0,
					"id" : "obj-127",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 609.0, 211.0, 154.0, 17.0 ],
					"text" : "jcom.remote sound/enveloppe",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 132.0, 436.0, 133.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 325.0, 541.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 40.0, 30.0, 15.0 ],
					"text" : "Rec",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "Rec",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 142.0, 541.0, 107.0, 17.0 ],
					"text" : "jcom.remote density/val",
					"varname" : "dispstart[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 393.0, 241.0, 145.0, 19.0 ],
					"text" : "jcom.remote currentBuffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 427.0, 140.0, 143.0, 17.0 ],
					"text" : "jcom.remote sound/random",
					"varname" : "hue_angle[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 630.0, 133.0, 124.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 5.0, 278.0, 61.0, 19.0 ],
					"text" : "jcom.view",
					"varname" : "jcom.model"
				}
...
,
					"patching_rect" : [ 468.333344, 179.0, 121.666656, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 599.0, 105.0, 112.0, 17.0 ],
					"text" : "jcom.remote sound/buffer",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-38",
					"items" : [ "G-train_flak+wouu02.aif", ",", "G-train_flak+wouu03.aif", ",", "G-train_flak+wouu04.aif", ",", "G-train_flak+wouu05.aif", ",", "G-train_flak+wouu06.aif", ",", "G-train_flak+wouu07.aif", ",", "G-train_flak+wouu08.aif", ",", "G-train_flak01.aif", ",", "G-train_flak02.aif", ",", "G-train_flak03.aif", ",", "G-train_flak04.aif" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 132.0, 496.0, 106.0, 17.0 ],
					"text" : "jcom.remote continuous",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 687.0, 311.0, 176.0, 19.0 ],
					"text" : "jcom.remote position/val"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 68.0, 365.0, 159.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 390.0, 80.0, 4.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.0, 3.0, 91.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 86.0, 464.0, 52.0, 19.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 519.0, 278.0, 63.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 156.0, 464.0, 141.0, 19.0 ],
					"text" : "jcom.remote pitch/val"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 499.0, 43.0, 112.0, 17.0 ],
					"text" : "jcom.remote sound/folder",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-71",
					"items" : [ "noneG-trains", ",", "G-trains", ",", "G-woop", ",", "G-ziit", ",", "L-oops" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 574.0, 390.0, 168.25, 19.0 ],
					"text" : "jcom.remote length/val"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.remote sound/bufferpool",
									"varname" : "sample/buffername[3]"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 89.0, 331.0, 52.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.remote amp/jit @type decimal"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.remote amp/val @type decimal"
								}
...
,
					"patching_rect" : [ 281.0, 187.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
						"description" : "",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 465.5, 374.0, 504.0, 374.0, 504.0, 272.0, 603.0, 272.0, 603.0, 272.0, 696.5, 272.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 748.833313, 375.0, 865.5, 375.0 ],
					"source" : [ "obj-43", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 633.25, 421.0, 844.5, 421.0 ],
					"source" : [ "obj-79", 1 ]
				}
