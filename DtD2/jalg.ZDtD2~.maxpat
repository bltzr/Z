{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 451.0, 220.0, 870.0, 661.0 ],
		"bglocked" : 0,
		"defrect" : [ 451.0, 220.0, 870.0, 661.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 500.0, 205.0, 43.0, 20.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 260.0, 50.0, 18.0 ],
					"text" : "1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 555.0, 410.0, 37.0, 19.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 295.0, 150.0, 42.0, 18.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 160.0, 50.0, 18.0 ],
					"text" : "resume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 160.0, 50.0, 18.0 ],
					"text" : "pause"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.0, 130.0, 113.0, 20.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 245.0, 40.0, 17.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 210.0, 50.0, 17.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "float" ],
					"patching_rect" : [ 490.0, 410.0, 38.0, 19.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 245.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 1044.0, 44.0, 338.0, 409.0 ],
						"bglocked" : 0,
						"defrect" : [ 1044.0, 44.0, 338.0, 409.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 245.0, 265.0, 60.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 194.5, 192.5, 89.5, 192.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 249.5, 192.5, 89.5, 192.5 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 570.5, 201.0, 89.5, 201.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 651.5, 201.0, 89.5, 201.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 0 ],
					"hidden" : 0,
					"midpoints" : [ 305.5, 200.5, 89.5, 200.5 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"hidden" : 0,
					"midpoints" : [ 123.5, 76.0, 84.5, 76.0 ],
					"source" : [ "obj-66", 0 ]
				}
