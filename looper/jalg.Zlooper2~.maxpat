{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 395.0, 262.0, 291.0, 209.0 ],
		"bglocked" : 0,
		"defrect" : [ 395.0, 262.0, 291.0, 209.0 ],
...
,
					"patching_rect" : [ 73.0, 121.0, 49.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 155.0, 34.0, 17.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 802.0, 468.0, 691.0, 490.0 ],
						"bglocked" : 0,
						"defrect" : [ 802.0, 468.0, 691.0, 490.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 243.0, 422.0, 17.0, 17.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 271.0, 350.0, 104.0, 20.0 ],
									"text" : "cycle~ #0env"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 233.0, 388.0, 57.0, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 214.0, 286.0, 67.0, 17.0 ],
									"text" : "*~"
								}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patching_rect" : [ 30.0, 195.0, 122.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 378.0, 209.0, 67.0, 30.0 ],
													"text" : "set #0_buff 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 159.0, 307.0, 122.0, 17.0 ],
													"text" : "set canoé.aiff 1"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 82.0, 54.0, 17.0 ],
									"text" : "r #0_buf"
								}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "float" ],
													"patching_rect" : [ 474.0, 181.0, 100.0, 20.0 ],
													"text" : "t b f"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 322.0, 300.0, 81.0, 20.0 ],
													"text" : "r #0_splgth"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-25", 0 ],
													"hidden" : 0,
													"midpoints" : [ 127.900002, 90.0, 439.5, 90.0 ],
													"source" : [ "obj-2", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-28", 0 ],
													"hidden" : 0,
													"midpoints" : [ 340.700012, 83.0, 300.5, 83.0 ],
													"source" : [ "obj-2", 3 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"hidden" : 0,
													"midpoints" : [ 127.900002, 90.0, 330.0, 90.0, 330.0, 162.0, 365.5, 162.0 ],
													"source" : [ "obj-2", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-38", 0 ],
													"hidden" : 0,
													"midpoints" : [ 553.5, 84.0, 659.0, 84.0 ],
													"source" : [ "obj-2", 5 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-4", 0 ],
													"hidden" : 0,
													"midpoints" : [ 127.900002, 153.0, 105.0, 153.0, 105.0, 193.0, 35.5, 193.0 ],
													"source" : [ "obj-2", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-22", 0 ],
													"hidden" : 0,
													"midpoints" : [ 331.5, 327.0, 416.5, 327.0 ],
													"source" : [ "obj-20", 0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 260.0, 227.0, 93.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "signal" ],
									"patching_rect" : [ 197.0, 141.0, 93.0, 17.0 ],
									"text" : "groove~ #0_buff 2"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-19", 0 ],
									"hidden" : 0,
									"midpoints" : [ 233.5, 112.0, 206.5, 112.0 ],
									"source" : [ "obj-13", 0 ]
								}
