...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 190.0, 167.0, 100.0, 18.0 ],
									"text" : "prepend hidden"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 125.0, 154.0, 22.0, 18.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 203.0, 86.0, 22.0, 18.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 104.0, 127.0, 92.0, 18.0 ],
									"text" : "sel 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.0, 9.0, 105.0, 18.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 195.0, 25.0, 25.0 ],
									"presentation" : 1,
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 51.5, 32.0, 212.5, 32.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 342.0, 12.0, 51.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 53.0, 95.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 85.0, 118.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 141.0, 125.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 18.0, 139.0, 14.0 ],
					"text" : "intensity",
					"textpos" : [ 10.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 251.0, 95.0, 50.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 125.0, 0.0, 24.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 183.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 98.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 278.5, 79.0, 103.5, 79.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 182.5, 74.0, 170.0, 74.0, 170.0, 14.0, 215.0, 14.0, 215.0, 14.0, 237.5, 14.0 ],
					"source" : [ "obj-9", 0 ]
				}
