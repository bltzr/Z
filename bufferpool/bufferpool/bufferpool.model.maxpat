...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 405.0, 58.0, 18.0 ],
					"text" : "route none"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter mainfolder @type generic @repetitions/filter 1 @description \"path of the parent folder dropped in, containing subfolders with sound files in \" @value/default none @tag init",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 295.0, 24.0, 20.0 ],
					"text" : "t 0"
				}
...
, 											{
												"box" : 												{
													...
													"text" : "Tumbleweed:/Users/tumble/Music/pièces/Nocturnes/NocturnesSons/ventilos"
												}
...
, 							{
								"box" : 								{
									...
									"prefix" : "Tumbleweed:/Users/tumble/Music/pièces/Nocturnes/NocturnesSons/ventilos/",
									"prefix_mode" : 2,
...
, 							{
								"box" : 								{
									...
									"prefix" : "Tumbleweed:/Users/tumble/Music/pièces/Nocturnes/NocturnesSons/",
									"types" : "fold"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 47.0, 296.0, 24.0, 20.0 ],
					"text" : "t 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 17.0, 296.0, 24.0, 20.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 266.0, 143.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 326.0, 181.0, 20.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 31.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 50.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.0, 50.0, 38.0, 17.0 ],
					"text" : "/init"
				}
