...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter enveloppe/attack @type decimal @description \"Attack of the enveloppe folower in ms\" @repetitions/allow 1 @range/bounds 0. 2000.",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 20.0, 33.0, 17.0 ],
					"text" : "input"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 445.0, 245.0, 31.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 40.0, 35.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 445.0, 305.0, 31.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 40.0, 33.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter enveloppe/release @type decimal @description \"Release of the enveloppe folower in ms\" @repetitions/allow 1 @range/bounds 0. 10000.",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 65.0, 20.0, 83.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 41.0, 150.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 40.0, 33.0, 17.0 ],
					"text" : "attack"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 39.0, 150.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 40.0, 45.0, 17.0 ],
					"text" : "releasse"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 20.0, 26.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 398.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 165.0, 370.0, 145.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 420.0, 100.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 58.0, 140.0, 8.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 454.5, 301.0, 431.0, 301.0, 431.0, 240.0, 454.5, 240.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 454.5, 361.0, 431.0, 361.0, 431.0, 300.0, 454.5, 300.0 ],
					"source" : [ "obj-17", 0 ]
				}
