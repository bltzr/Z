{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1200.0, 630.0, 300.0, 70.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 36.0, 65.0, 1152.0, 631.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "j.model @module_type audio @description \"Reverb module using gigaverb~ \"",
					"varname" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter revtime @type decimal @repetitions/allow 1 @range/bounds 0.1 360. @description \"• Reverb time (s): Reverb decay time, in seconds. 7 is a good place to start. Values: 0.1 - 360 seconds!\"",
					"varname" : "bands[3]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter clear @type none @repetitions/allow 1 @description \"• Clear the delay lines after a DSP overblow or to get rid of any remaining delay tailes.\"",
					"varname" : "bands[6]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.oscroute /roomsize /damping /revtime /bandwidth /early /tail /audio/bypass /clear"
				}
