{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 241.0, 236.0, 1147.0, 626.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 241.0, 236.0, 1147.0, 626.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 525.0, 225.0, 27.0, 27.0 ],
					"id" : "obj-6",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "VIDEO  IMAGE TOTALE",
					"linecount" : 2,
					"patching_rect" : [ 560.0, 230.0, 87.0, 31.0 ],
					"id" : "obj-7",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 370.0, 230.0, 27.0, 27.0 ],
					"id" : "obj-4",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "VIDEO BRAS D",
					"patching_rect" : [ 405.0, 235.0, 87.0, 19.0 ],
					"id" : "obj-5",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 270.0, 235.0, 27.0, 27.0 ],
					"id" : "obj-1",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "VIDEO  TETE",
					"patching_rect" : [ 265.0, 215.0, 76.0, 19.0 ],
					"id" : "obj-2",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"presentation_rect" : [ 90.0, 20.0, 60.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "VIDEO OUTPUT",
					"patching_rect" : [ 75.0, 425.0, 86.0, 19.0 ],
					"id" : "obj-32",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 40.0, 425.0, 27.0, 27.0 ],
					"id" : "obj-33",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "VIDEO BRAS G",
					"patching_rect" : [ 90.0, 240.0, 85.0, 19.0 ],
					"id" : "obj-35",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jalg.teteBras",
					"patching_rect" : [ 36.0, 355.0, 280.0, 19.0 ],
					"id" : "obj-36",
					"fontname" : "Verdana",
					"numinlets" : 5,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 417.299988, 342.0, 45.5, 342.0 ]
				}
