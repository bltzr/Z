{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 15.0, 225.0, 300.0, 70.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 240.0, 280.0, 1174.0, 706.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "j.parameter invert @type boolean @description \"invert the sensor output\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 702.0, 44.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 282.0, 54.0, 15.0, 15.0 ],
					"varname" : "/Zkroonde.4togauto[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 46.0, 75.0, 17.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 250.0, 44.0, 34.0, 27.0 ],
					"text" : "invert output"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.return trigger/high @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.return trigger/low @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 55.0, 51.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.0, 54.0, 65.0, 17.0 ],
					"text" : "trigger high"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 282.0, 32.0, 15.0, 15.0 ],
					"varname" : "/Zkroonde.4togauto"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.0, 304.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 124.0, 286.0, 15.0, 15.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 506.0, 140.0, 19.996094, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 284.0, 2.0, 31.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 116.0, 71.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 116.0, 71.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 322.0, 136.0, 35.0, 20.0 ],
									"text" : "== 0"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "j.oscroute /range/low /range/high"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 50.0, 100.0, 264.0, 17.0 ],
									"text" : "j.oscroute /calibration/low /calibration/high /invert"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 90.0, 266.0, 49.0, 20.0 ],
					"text" : "j.in"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.model @module_type control @description \"module for 1 sensor from kroonde\"",
					"varname" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 246.0, 2.0, 51.0, 17.0 ],
					"text" : "sensor#"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.return threshold/high @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.return threshold/low @type integer"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter sensor/name @type array @description \"Name of the sensor\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 622.0, 562.0, 88.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 678.0, 538.0, 31.0, 17.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 54.0, 51.0, 17.0 ],
					"text" : "trigger low"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 694.0, 354.0, 31.0, 17.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.0, 378.0, 88.0, 17.0 ],
					"text" : "sprintf set %ld %ld"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 448.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 40.0, 43.0, 27.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 20.0, 42.0, 84.0, 27.0 ],
					"text" : "trigger\nrange"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 494.5, 455.0, 527.5, 455.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 631.5, 597.0, 932.0, 597.0, 932.0, 406.0, 715.0, 406.0, 715.0, 407.0, 691.0, 407.0, 691.0, 413.0, 445.5, 413.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"hidden" : 0,
					"midpoints" : [ 647.5, 401.0, 458.0, 401.0, 458.0, 252.0, 484.5, 252.0 ],
					"source" : [ "obj-53", 0 ]
				}
