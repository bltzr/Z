{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 157.0, 394.0, 652.0, 372.0 ],
		"bglocked" : 0,
		"defrect" : [ 157.0, 394.0, 652.0, 372.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 356.0, 247.0, 50.0, 17.0 ],
					"text" : "line~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 405.0, 65.0, 160.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 403.0, 101.0, 124.0, 17.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 378.0, 75.0, 1062.0, 738.0 ],
						"bglocked" : 0,
						"defrect" : [ 378.0, 75.0, 1062.0, 738.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 354.0, 150.0, 1002.0, 637.0 ],
										"bglocked" : 0,
										"defrect" : [ 354.0, 150.0, 1002.0, 637.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 14.0, 144.0, 15.0, 15.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 60.0, 148.0, 78.0, 17.0 ],
									"text" : "jcom.metro 1000"
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 322.5, 256.0, 45.0, 256.0, 45.0, 139.0, 99.0, 139.0 ],
									"source" : [ "obj-29", 0 ]
								}
...
,
					"patching_rect" : [ 560.0, 153.0, 53.0, 23.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
,
					"patching_rect" : [ 461.0, 153.0, 83.0, 23.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 403.0, 157.0, 38.0, 17.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 196.0, 32.0, 15.0 ],
					"text" : "1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 403.0, 176.0, 34.0, 17.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 61.0, 242.0, 50.0, 17.0 ],
					"text" : "line~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 110.0, 60.0, 160.0, 17.0 ],
					"text" : "jcom.oscroute /mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 108.0, 96.0, 124.0, 17.0 ],
					"text" : "t i i i"
				}
...
,
					"patching_rect" : [ 265.0, 148.0, 53.0, 23.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
,
					"patching_rect" : [ 166.0, 148.0, 83.0, 23.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 108.0, 152.0, 38.0, 17.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 191.0, 32.0, 15.0 ],
					"text" : "1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 108.0, 171.0, 34.0, 17.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 303.0, 217.0, 37.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 297.0, 44.0, 20.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 303.0, 270.0, 45.0, 17.0 ],
					"text" : "*~"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 1 ],
					"hidden" : 0,
					"midpoints" : [ 260.5, 119.0, 308.5, 119.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 222.5, 133.0, 274.5, 133.0 ],
					"source" : [ "obj-13", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 274.5, 234.0, 70.5, 234.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 175.5, 234.0, 70.5, 234.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 117.5, 235.0, 70.5, 235.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 569.5, 239.0, 365.5, 239.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 470.5, 239.0, 365.5, 239.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 412.5, 240.0, 365.5, 240.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 555.5, 124.0, 603.5, 124.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"hidden" : 0,
					"midpoints" : [ 517.5, 138.0, 569.5, 138.0 ],
					"source" : [ "obj-8", 2 ]
				}
