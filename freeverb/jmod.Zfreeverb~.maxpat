...
, 			{
				"box" : 				{
					...
					"text" : "j.model @module_type audio @description \"Reverb module using Freeverb~ \"",
					"varname" : "j.model"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter roomsize @type decimal @repetitions/allow 1 @range/bounds 0. 10. @description \"The size of the room to be simulated: larger values result in a longer reverb tail. Values above 1. will result in feedback or 'room resonance' (i.e. the reverb getting louder and louder).\"",
					"varname" : "bands[1]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter width @type decimal @repetitions/allow 1 @range/bounds 0. 1. @description \"The stereo width of the reverb, i.e. how much the reverb part from left and right channel mix. Turning this to 1 (nearly) gives two seperate mono reverbs.\"",
					"varname" : "bands[3]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter freeze @type integer @repetitions/allow 1 @range/bounds 0 1 @description \"Start and stop freeze mode (off by default). If on, reverb tail gets freezed (sample and hold).\"",
					"varname" : "bands[6]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.oscroute /roomsize /damping /width /freeze /audio/bypass"
				}
