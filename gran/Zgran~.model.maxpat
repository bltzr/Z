...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter display/length @type decimal @priority 12 @repetitions/allow 0"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter display/start @type decimal @priority 13 @repetitions/allow 0"
				}
