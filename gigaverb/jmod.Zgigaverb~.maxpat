...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter revtime @type decimal @repetitions/filter 0 @range 0.1 360. @description \"• Reverb time (s): Reverb decay time, in seconds. 7 is a good place to start. Values: 0.1 - 360 seconds!\"",
					"varname" : "bands[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "" ],
<<<<<<< HEAD
					"patching_rect" : [ 577.0, 510.0, 647.0, 31.0 ],
...
=======
					...
					"text" : "j.parameter clear @type none @repetitions/filter 0 @description \"• Clear the delay lines after a DSP overblow or to get rid of any remaining delay tailes.\"",
>>>>>>> dyew
					"varname" : "bands[6]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "" ],
<<<<<<< HEAD
					"patching_rect" : [ 579.0, 432.0, 598.0, 31.0 ],
