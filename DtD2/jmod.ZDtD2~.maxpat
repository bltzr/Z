...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter selectedfile @type string @repetitions/allow 0 @description \"path of the soundfile played \" @priority 31",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 225.0, 55.0, 32.0, 17.0 ],
					"text" : "time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 689.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 697.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter balance @type decimal @range/bounds -1 1 @range/clipmode both @ramp/drive scheduler @description \"Balance of the stereo signal\""
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.parameter rampmode @type integer @repetitions/allow 1 @description \"Enveloppe mode : cut, fadein, fadeout\" @priority 32",
					"varname" : "loop[2]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 65.0, 37.0, 29.0, 15.0 ],
					"text" : "loop",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "loop",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ],
